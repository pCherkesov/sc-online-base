...
$query="SELECT DATE_FORMAT(r.date, '%d.%m.%Y') AS date, t.type, b.brand, m.model, c.client, c.client_tel_0, r.client_fio, r.client_tel, r.counter, r.serial, p.prin, r.defect, r.complect
...
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
    $report = file_get_contents("Forms/act_priema.html");
    ...
    else $report = str_replace("{%passwd%}", "", $report);
