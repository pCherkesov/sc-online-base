...
*/
	...
	function __construct () {
			$word_month = array ("ÍÓËßÁÐÜ", "ßÍÂÀÐÜ", "ÔÅÂÐÀËÜ", "ÌÀÐÒ", "ÀÏÐÅËÜ", "ÌÀÉ", "ÈÞÍÜ", "ÈÞËÜ", "ÀÂÃÓÑÒ", "ÑÅÍÒßÁÐÜ", "ÎÊÒßÁÐÜ", "ÍÎßÁÐÜ", "ÄÅÊÀÁÐÜ");
...
class work_detail {
		...
		static function view_footer ( $znaki ) {
		  $string  = "<img src='Images/Icon/s_0_".$znaki[0].".png' border='0' name='s_0' alt='Ïðîñðî÷åíî' />";
  		$string .= "<img src='Images/Icon/s_1_".$znaki[1].".png' border='0' name='s_1' alt='Ïðîáëåìà' />";
  		$string .= "<img src='Images/Icon/s_2_".$znaki[2].".png' border='0' name='s_2' alt='Êëèåíò ñîãëàñåí' />";
  		$string .= "<img src='Images/Icon/s_3_".$znaki[3].".png' border='0' name='s_3' alt='Òðåáóåòñÿ ñîãëàøåíèå' />";
  		$string .= "<img src='Images/Icon/s_4_".$znaki[4].".png' border='0' name='s_4' alt='!!! ÂÍÈÌÀÍÈÅ !!!' />";
  		$string .= "<img src='Images/Icon/s_5_".$znaki[5].".png' border='0' name='s_5' alt='Ðåìîíò çàêîí÷åí' />";
  		$string .= "<img src='Images/Icon/s_6_".$znaki[6].".png' border='0' name='s_6' alt='Íåóäà÷à' />";
  		$string .= "<img src='Images/Icon/s_7_".$znaki[7].".png' border='0' name='s_7' alt='Æä¸ì ïîñòàâêè' />";
